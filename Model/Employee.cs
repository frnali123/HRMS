...
namespace HRMS.Model
{
    ...
    // --- यह आपकी मुख्य ग़लती थी ---
    // इसे Guid.NewGuid() से हटा दें।
    // यह Foreign Key है जो User टेबल से आएगी।
    ...
    // This tells EF that one Employee has many Attendances

    [ForeignKey("UserId")]
    public virtual User User { get; set; }
    public virtual ICollection<Attendance> Attendances { get; set; }

    // This tells EF that one Employee has many Leaves
